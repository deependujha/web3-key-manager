...
const Info = () => {
	return (
		<div className="container mx-auto my-10">
			<div className="text-4xl flex justify-center my-5 font-bold">
			...
			<div className="md:grid md:grid-cols-3 ">
				...
				<div className="mx-5 my-3">
					...
					<Card
						...
						text="Store all of your passwords securely in encrypted format on IPFS."
					/>
				</div>
				<div className="mx-5 my-3">
					{' '}
			...
			<div className="md:grid md:grid-cols-3 ">
				...
				<div className="mx-5 my-3">
					...
					<Card
						...
						text="Buy our premium plans to store more password secuely."
					/>
				</div>
			</div>
		</div>
